...
function mostrarModalExito(nombre, especialidad) {
    ...
    modal.innerHTML = `
        <div id="modal-background" style="position: fixed; inset: 0; background: rgba(0, 0, 0, 0.85); z-index: 9999; display: flex; align-items: center; justify-content: center; padding: 20px; backdrop-filter: blur(5px); animation: fadeIn 0.3s ease;">
            <div id="modal-content" style="background: white; padding: 50px; border-radius: 24px; max-width: 500px; width: 100%; text-align: center; box-shadow: 0 25px 50px rgba(0, 0, 0, 0.3); animation: slideUp 0.4s ease;">
                
                <!-- Icono de éxito -->
                <div style="width: 90px; height: 90px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; box-shadow: 0 10px 30px rgba(16, 185, 129, 0.3);">
                    <i class="fas fa-check" style="font-size: 45px; color: white;"></i>
                </div>
                
                <!-- Título -->
                <h2 style="font-size: 36px; color: #1e293b; margin-bottom: 16px; font-family: 'Playfair Display', serif; font-weight: 700;">
                    ¡Solicitud Enviada!
                </h2>
                
                <!-- Mensaje -->
                <p style="color: #64748b; font-size: 18px; margin-bottom: 30px; line-height: 1.7;">
                ...
                <p style="color: #64748b; font-size: 16px; margin-bottom: 35px;">
                    Te contactaremos pronto por correo electrónico o teléfono.
                </p>
                
                <!-- Información adicional -->
                <div style="background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 16px; padding: 20px; margin-bottom: 30px;">
                    <p style="color: #475569; font-size: 15px; margin: 0;">
                        <i class="fas fa-info-circle" style="color: #d4af37; margin-right: 8px;"></i>
                        Revisa tu bandeja de entrada para la confirmación
                    </p>
                </div>
                ...
                <button id="btn-cerrar-modal"
                        class="gradient-gold"
                        style="border: none; color: #1e293b; padding: 18px 40px; border-radius: 12px; font-weight: 700; font-size: 16px; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 15px rgba(212, 175, 55, 0.4); width: 100%;">
...
function mostrarNotificacion(mensaje, tipo = 'success') {
    ...
    notification.innerHTML = `
        <div style="position: fixed; top: 30px; right: 30px; ${estilos} color: white; padding: 20px 28px; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); z-index: 10000; font-weight: 600; max-width: 400px; display: flex; align-items: center; gap: 12px; animation: slideIn 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55);">
            ${icono}
